<%-- 
    Document   : paint
    Created on : 19 May, 2017, 5:54:15 PM
    Author     : lenovo
--%>
                    ...
                    <div>
                        ...
                        <div class="sub">
                                ...
                                <div class="row subrow">
                                    ...
                                    <div class="col-md-3"><div class="subinner"><input class="input" type="checkbox" name="cb"  id="f1" onClick="get()" value="acrylic" >&nbsp;&nbsp;Acrylic painting</div></div>
                                    <div class="col-md-2"></div>
                                    <div class="col-md-3"><div class="subinner"><input class="input" type="checkbox"  value="oil" name="cb"  id="f2" onClick="get()" >&nbsp;&nbsp;Oil painting</div></div>
                                    <div class="col-md-1"></div>
                                </div>
                                <div class="row subrow">
                                    <div class="col-md-1"></div>
                                    <div class="col-md-3"><div class="subinner"><input class="input"  type="checkbox" name="cb"  id="f3" onClick="get()" value="sand">&nbsp;&nbsp;Sand painting</div></div>
                                    <div class="col-md-2"></div>
                                    <div class="col-md-3"><div class="subinner"><input class="input" type="checkbox" value="digital" name="cb"  id="f4" onClick="get()">&nbsp;&nbsp;Digital painting</div></div>
                                    <div class="col-md-1"></div>
                                </div>                       
                        </div>
